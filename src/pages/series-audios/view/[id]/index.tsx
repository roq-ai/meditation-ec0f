...
import { getSeriesAudioById } from 'apiSdk/series-audios';
import { SeriesAudioInterface } from 'interfaces/series-audio';

function SeriesAudioViewPage() {
              ...
              >
                ...
                {hasAccess('series', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Series"
                    text={
                      <Link as={NextLink} href={`/series/view/${data?.series?.id}`}>
                        {data?.series?.title}
                      </Link>
                    }
                  />
